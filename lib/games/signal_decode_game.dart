...
import '../grading/signal_decode_grading.dart';
...
class _SignalDecodeGameState extends State<SignalDecodeGame> {
  ...
  Map<String, double> grade() {
    return SignalDecodeGrading.grade(
      rtSimpleTotal: _rtSimpleTotal,
      rtSimpleHits: _rtSimpleHits,
      rtSimpleRTs: _rtSimpleRTs,
      spatialTotal: _spatialTotal,
      spatialCorrect: _spatialCorrect,
      spatialRTs: _spatialRTs,
      emotionTotal: _emotionTotal,
      emotionCorrect: _emotionCorrect,
      emotionRTs: _emotionRTs,
      memoryTotal: _memoryTotal,
      memoryCorrect: _memoryCorrect,
      memoryRTs: _memoryRTs,
      balanceTotal: _balanceTotal,
      balanceCorrect: _balanceCorrect,
      balanceRTs: _balanceRTs,
    );
  }
